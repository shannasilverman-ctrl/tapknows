        ...
        {items.map((it) => {
          ...
          return (
            <Link
              ...
              className={`flex flex-col items-center justify-center gap-0.5 min-h-11 min-w-11 px-3 py-1.5 rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50 ${
