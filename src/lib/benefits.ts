...
export const BENEFITS: CardBenefit[] = [
  ...
  // ── Chase Sapphire Preferred ─────────────────────────────────────────────
  {
    ...
    note: "Hotel stays purchased through Chase Travel. Resets each account anniversary.",
  },
  {
    id: "chase_csp_trusted_traveler",
    card_catalog_id: "chase_csp",
    label: "Global Entry, TSA PreCheck or NEXUS credit",
    kind: "standing",
    cadence: "annual",
    value_cents: null,
    ...
    summary: "Up to $120 back every four years.",
    terms:
      "Pay the Global Entry, TSA PreCheck or NEXUS application fee with the card to receive up to $120 back every four years. Eligibility and terms apply.",
    coverage_cap: "Up to $120 every four years",
    source_url: "https://www.chase.com/sapphire-cards/personal/preferred",
    verified_on: "2026-07-26",
  },
  {
    id: "chase_csp_emergency_evacuation",
    card_catalog_id: "chase_csp",
    ...
    summary: "Coverage on eligible trips 100+ miles from home.",
    terms:
      "If a covered traveler is injured or becomes sick on an eligible trip 100 miles or more from home, covered medical services and emergency transportation may be reimbursed. Eligibility and terms apply.",
    coverage_cap: "Up to $100,000",
    source_url: "https://www.chase.com/sapphire-cards/personal/preferred",
    verified_on: "2026-07-26",
  },
  {
    id: "chase_csp_auto_rental",
    card_catalog_id: "chase_csp",
    label: "Primary auto rental coverage",
    kind: "standing",
    cadence: "annual",
    value_cents: null,
    source: "https://www.chase.com/sapphire-cards/personal/preferred",
    group: "travel",
    title: "Primary rental car coverage",
    summary: "Eligible theft and collision damage when you pay with the card.",
    terms:
      "Decline the rental company's collision insurance and charge the entire eligible rental to the card. Coverage is primary for most eligible rental vehicles. Eligibility, vehicle and country exclusions apply.",
    coverage_cap: "Up to $60,000",
    source_url: "https://www.chase.com/sapphire-cards/personal/preferred",
    verified_on: "2026-07-26",
  },
  {
    id: "chase_csp_trip_cancellation",
    card_catalog_id: "chase_csp",
    label: "Trip cancellation and interruption",
    kind: "standing",
    cadence: "annual",
    value_cents: null,
    source: "https://www.chase.com/sapphire-cards/personal/preferred",
    ...
    summary: "Eligible prepaid travel expenses can be reimbursed.",
    terms:
      "Eligible prepaid, non-refundable travel expenses may be reimbursed when a covered trip is canceled or cut short for a covered reason. Eligibility and terms apply.",
    coverage_cap: "Up to $10,000 per traveler and $20,000 per trip",
    source_url: "https://www.chase.com/sapphire-cards/personal/preferred",
    verified_on: "2026-07-26",
  },
  {
    id: "chase_csp_trip_delay",
    card_catalog_id: "chase_csp",
    ...
    summary: "Meals and lodging after an eligible 12+ hour delay.",
    terms:
      "Unreimbursed expenses such as meals and lodging may be covered when eligible common-carrier travel is delayed more than 12 hours or requires an overnight stay. Eligibility and terms apply.",
    coverage_cap: "Up to $500 per covered traveler",
    source_url: "https://www.chase.com/sapphire-cards/personal/preferred",
    verified_on: "2026-07-26",
  },
  {
    id: "chase_csp_baggage_delay",
    card_catalog_id: "chase_csp",
    ...
    group: "travel",
    title: "Baggage delay",
    summary: "Essential purchases after an eligible 6+ hour delay.",
    terms:
      "Essential purchases such as toiletries and clothing may be reimbursed when eligible baggage is delayed more than six hours. Eligibility and terms apply.",
    coverage_cap: "Up to $100 a day for 5 days",
    source_url: "https://www.chase.com/sapphire-cards/personal/preferred",
    verified_on: "2026-07-26",
  },
  {
    id: "chase_csp_purchase_protection",
    card_catalog_id: "chase_csp",
    label: "Purchase protection",
    kind: "standing",
    cadence: "annual",
    ...
    terms:
      "Eligible new purchases may be covered against damage or theft for 120 days from the purchase date. Eligibility and terms apply.",
